                        ...
                        <div class="block block-rounded">
                            ...
                            <div class="block-content p-0 overflow-hidden border-bottom">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <textarea class="form-control" name="dtl[alamat_donatur]" required>{{ $data->alamat_donatur }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" value="{{ $data->kecamatan_donatur }}" name="dtl[kecamatan_donatur]" placeholder=".......">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" value="{{ $data->kota_donatur }}" name="dtl[kota_donatur]" placeholder=".......">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" value="{{ $data->provinsi_donatur }}" name="dtl[provinsi_donatur]" placeholder=".......">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" value="{{ $data->bank_donatur }}" name="dtl[bank_donatur]" placeholder=".......">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control" value="{{ $data->nm_rek_donatur }}" name="dtl[nm_rek_donatur]" placeholder=".......">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" value="{{ $data->rekening_donatur }}" name="dtl[rekening_donatur]" placeholder=".......">
                                    </div>
                                </div>
                            </div>
