<div class="modal fade slide-right" id="modal_create_donasi" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="row-xs-height">
                        <div class="modal-body col-xs-height col-middle">
                            <div class=" container-fluid container-fixed-md">
                                <form method="POST" id="form_create" action="{{ route('donasi.create') }}"
                                      role="form" autocomplete="off">
                                    @csrf
                                    <input type="hidden" name="created_by" value="{{ $created_by }}">
                                    <div class="row clearfix mx-auto">
                                        <h3>Buat Jenis Donasi Baru</h3>
                                    </div>
                                    <hr>
