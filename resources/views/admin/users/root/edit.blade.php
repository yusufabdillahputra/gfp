...
@section('modal')
    ...
    {{ view('admin.users.root.modal.foto', ['id_users' => $data->id_users]) }}
@endsection
        ...
        <div class="row">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-block">
                        ...
                        <div class="pull-right">
                            <a href="#modal_upload_root" data-toggle="modal" class="btn btn-primary">Ubah Foto</a>
                        </div>
                    </div>
                </div>
                <!-- END card -->
            ...
            <div class="col-md-8">
                ...
                <div class="card card-transparent">
                    <div class="card-block">
                        <form method="POST" id="form_edit" action="{{ route('users.root.edit.post') }}"
...
@push('content_js')
    <script src="{{ asset('js/admin/users/root/dropzone_root.js') }}" type="text/javascript"></script>
    <script src="{{ asset('js/admin/users/root/form_edit_root.js') }}" type="text/javascript"></script>
