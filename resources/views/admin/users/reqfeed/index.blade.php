            ...
            <div class="card-block">
                <div class="row clearfix">
                    ...
                    <div class="col-md-3">
                        ...
                        <select id="dt_reqfeed_length" class="cs-select cs-skin-slide"
                    ...
                    <div class="col-md-7">
                        <div class="form-group form-group-default input-group">
                            <div class="form-input-group">
                                <label>Search</label>
                                <input type="text" id="dt_reqfeed_search" class="form-control pull-right"
                                       placeholder="Masukkan kata pencarian...">
                            </div>
                            <div class="input-group-addon">
                                <a href="javascript:void(0)" id="dt_reqfeed_submit">
                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        <table class="table table-striped" id="dt_reqfeed"></table>
                    </div>
                </div>
            </div>
        </div>
...
@push('content_js')
    <script src="{{ asset('js/admin/users/reqfeed/datatable_reqfeed.js') }}" type="text/javascript"></script>
