...
@section('modal')
    ...
    {{ view('admin.users.admin.modal.foto', ['id_users' => $data->id_users]) }}
@endsection
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="row my-md-2">
                    <div class="col-md-12">
                        <a href="{{ route('users.admin.index') }}" class="btn btn-warning btn-cons btn-block btn-animated from-left fa fa-arrow-left mt-2"><span>Kembali</span></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-default">
                            ...
                            <div class="card-block">
                                ...
                                <div class="pull-right">
                                    <a href="#modal_upload_admin" data-toggle="modal" class="btn btn-primary">Ubah Foto</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-8">
                ...
                <div class="card card-transparent">
                    <div class="card-block">
                        <form method="POST" id="form_edit" action="{{ route('users.admin.edit.post') }}"
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <label>Alamat</label>
                                        <textarea class="form-control" name="dtl[alamat_admin]"
                                                  required>{{ $data->alamat_admin }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <label>Kecamatan</label>
                                        <input type="text" class="form-control" value="{{ $data->kecamatan_admin }}"
                                               name="dtl[kecamatan_admin]" placeholder=".......">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input type="text" class="form-control" value="{{ $data->kota_admin }}"
                                               name="dtl[kota_admin]" placeholder=".......">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <label>Provinsi</label>
                                        <input type="text" class="form-control" value="{{ $data->provinsi_admin }}"
                                               name="dtl[provinsi_admin]" placeholder=".......">
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <label>Bank</label>
                                        <input type="text" class="form-control" value="{{ $data->bank_admin }}"
                                               name="dtl[bank_admin]" placeholder=".......">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <label>Rekening Atas Nama</label>
                                        <input type="text" class="form-control" value="{{ $data->nm_rek_admin }}"
                                               name="dtl[nm_rek_admin]" placeholder=".......">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input type="text" class="form-control" value="{{ $data->rekening_admin }}"
                                               name="dtl[rekening_admin]" placeholder=".......">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card card-transparent">
                    ...
                    <div class="card-block">
                        ...
                        <form action="{{ route('users.rule.update') }}" method="POST" class="form-horizontal" role="form" autocomplete="off">
                            ...
                            @if($session['akses_users'] == env('AKSES_ROOT'))
                            {{-- START users -> admin --}}
                            <div class="form-group row">
                                <label class="col-md-3 control-label">Pengguna Admin</label>
                                <div class="col-md-9">
                                    <p>Read</p>
                                    <p class="hint-text small">Apa anda ingin pengguna berikut ini dapat melihat isi konten ?</p>
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="radio radio-success">
                                                <input type="radio" name="users_admin_read"
                                                       @if($rules->users->admin->read == 1) checked="checked" @endif
                                                       value="1" id="users_admin_read_true">
                                                <label for="users_admin_read_true">Ya</label>

                                                <input type="radio" name="users_admin_read"
                                                       @if($rules->users->admin->read == 0) checked="checked" @endif
                                                       value="0" id="users_admin_read_false">
                                                <label for="users_admin_read_false">Tidak</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {{-- START users -> donatur --}}
                            <div class="form-group row">
                                <label class="col-md-3 control-label">Pengguna Donatur</label>
                                <div class="col-md-9">
                                    <p>Read</p>
                                    <p class="hint-text small">Apa anda ingin pengguna berikut ini dapat melihat isi konten ?</p>
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="radio radio-success">
                                                <input type="radio" name="users_donatur_read"
                                                       @if($rules->users->donatur->read == 1) checked="checked" @endif
                                                       value="1" id="users_donatur_read_true">
                                                <label for="users_donatur_read_true">Ya</label>

                                                <input type="radio" name="users_donatur_read"
                                                       @if($rules->users->donatur->read == 0) checked="checked" @endif
                                                       value="0" id="users_donatur_read_false">
                                                <label for="users_donatur_read_false">Tidak</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@push('content_js')
    <script src="{{ asset('js/admin/users/admin/dropzone_admin.js') }}" type="text/javascript"></script>
    <script src="{{ asset('js/admin/users/admin/form_edit_admin.js') }}" type="text/javascript"></script>
