$(document).ready(function () {
    'use strict';
    var search_input = $('#dt_transaksi_search');
    var lenght_select = $('#dt_transaksi_length');
    var btn_submit = $('#dt_transaksi_submit');
    var table = $('#dt_transaksi');
             ...
             */
            {
                ...
                data: function (row, type, val, meta) {
                    if (row.jenis_transaksi == 1) {
                        return 'Top Up';
                    } if (row.jenis_transaksi == 2) {
                        return 'Donasi';
                    } if (row.jenis_transaksi == 3) {
