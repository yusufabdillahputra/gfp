$(document).ready(function () {
    ...
    $(document).on("click", ".modal_delete_e_feed", function () {
        ...
        $('.block-content #d_id_img_feed').val(id_img_feed);
        $('.block-content #d_path_img_feed').html('<img class="img-fluid" src="'+path_img_feed+'">');
    });
    ...
    $(document).on("click", ".modal_thumbnail_e_feed", function () {
        ...
        $('.block-content #t_id_img_feed').val(id_img_feed);
        $('.block-content #t_id_feed').val(id_feed);
        $('.block-content #t_updated_by').val(updated_by);
        $('.block-content #t_path_img_feed').html('<img class="img-fluid" src="'+path_img_feed+'">');
    });
