$(document).ready(function () {
    'use strict';
    var search_input = $('#dt_pengguna_donatur_search');
    var lenght_select = $('#dt_pengguna_donatur_length');
    var btn_submit = $('#dt_pengguna_donatur_submit');
    var table = $('#dt_pengguna_donatur');
        ...
        columns: [
            ...
            },
            {
                ...
                data: function (row, type, val, meta) {
                    return DateFormat.format.prettyDate(row.created_at_users);
                }
            },
            {
                title: 'Aksi',
