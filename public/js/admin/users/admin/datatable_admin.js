$(document).ready(function () {
    'use strict';
    var search_input = $('#dt_pengguna_admin_search');
    var lenght_select = $('#dt_pengguna_admin_length');
    var btn_submit = $('#dt_pengguna_admin_submit');
    var table = $('#dt_pengguna_admin');
